(function(blink) {
    ...
    var AbpStyle = function() {
        blink.theme.styles.basic.apply(this, arguments);
    }

    AbpStyle.prototype = {
        parent: blink.theme.styles.basic.prototype,
        bodyClassName: 'content_type_clase_abp',
        esIndice: false,
        ckEditorStyles: {
            name: 'abp',
            styles: [{
    ...
    AbpStyle.prototype = _.extend({}, new blink.theme.styles.basic(), AbpStyle.prototype);

    blink.theme.styles['aprendizaje_basado_en_proyectos'] = AbpStyle;

    blink.events.on('digitalbook:bpdfloaded', function() {
        // Ejemplo carga de datos del curso desde un libro digital.
        blink.getCourse(idcurso).done(function(data) {
            var style = new AbpStyle;
